...
const Structure: React.FC = () => {
  ...
  return (
    <>
      ...
      {/* --- Round 1 --- */}
      <div
        className="px-10 grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center mb-16 md:mb-20"
        ref={(el) =>
          el &&
          !elementRefs.current.includes(el) &&
          elementRefs.current.push(el)
      ...
      {/* --- Round 3 --- */}
      <div
        className="px-10 grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center mb-2"
        ref={(el) =>
          el &&
          !elementRefs.current.includes(el) &&
          elementRefs.current.push(el)
